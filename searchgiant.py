...
parser.add_argument('project_name', metavar = 'project_name', type=str, nargs=1, help="Name of project. Will be a folder created in the current working directory. If project already exists it will use existing settings")
...
if args.service[0].lower() == "google_drive":
    g = GoogleDrive.GoogleDrive(args.project_name[0])
    g.full_sync()
